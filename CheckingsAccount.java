...
public class CheckingsAccount implements BankAccount{
    public CheckingsAccount(){
        ...
        System.out.println("Thank you for choosing to open a checkings account with us today!");
    ...
    public void deposit(){
        ...
        input.close();
        newBalance = Double.parseDouble(deposit) + this.balance - this.transactionFee;
    ...
    public void deposit(double num){
        ...
        input.close();
        newBalance = Double.parseDouble(deposit) + num - this.transactionFee;
        writeToFile(newBalance, PIN, clientNumber); 
    }
    ...
    public void withdraw(){
        ...
        input.close();
        newBalance = this.balance - Double.parseDouble(deposit) - this.transactionFee;
        writeToFile(newBalance, PIN, clientNumber);
    }
    ...
    public void writeToFile(double balance, int PIN, int clientNumber){
        String PINbinary = Integer.toBinaryString(PIN);
        String clientNumberBinary = Integer.toBinaryString(clientNumber);
        String[] lines = new String[5];
            try{
                ...
                lines[1] = Double.toString(balance); // 2nd line saves checkings account
    ...
    private final double transactionFee = 0.35;
}